...
vq60 = h5py.File('../Output-u50-wo-gamma-newgiw/adga-20180126-013536.333-output.hdf5','r')
...
plt.legend(loc='top right', frameon=False)
...
plt.tight_layout()
plt.savefig('layer-2x3--ins--ineq1.eps', bbox_inches='tight', format='eps', dpi=600, rasterized=True)
