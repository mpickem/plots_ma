...
layer = h5py.File('/home/lv70585/pickemERC/MA_ADGA_runs/Output-u43-full-threeleg-gamma/adga-20171214-211849.115-output.hdf5','r')
...
f = plt.figure(figsize=(6,3)) # this looks good
gs1 = gridspec.GridSpec(1,2)
gs1.update(hspace=0, wspace=0.75)
...
cb1 = plt.colorbar(ticks=[a,a+(b-a)/3,a+(b-a)*2/3, b], format='%.3f', shrink=0.570)
...
plt.savefig('susc_bulk_b38.eps', bbox_inches='tight', format='eps', dpi=600, Rasterized=True)
plt.show()
