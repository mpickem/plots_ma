...
# asy = h5py.File('../Output-SrVO3-calcgiw--bugfix--N60/adga-20171027-123755.561-output.hdf5','r')
# asy = h5py.File('../Output-SrVO3-calcgiw--bugfix--N120/adga-20171127-115126.190-output.hdf5','r')
...
for ikx in xrange(20):
    for iky in xrange(20):
        for ikz in xrange(1):
            ...
            polynomial = poly.polyfit(fmats[:5], siwdga[0,0,ikx,iky,ikz,frequencies:frequencies+5].imag, deg=3)
...
plt.tight_layout()
plt.savefig('1x4_gamma_b10_n200.eps', bbox_inches='tight', format='eps', dpi=600, Rasterized=True)
plt.show()
